...
if(isset($_GET['id'])){ 
$required='';
$idd=get_safe_value($con,$_GET['idd']);
...
?>
	<div class="mainbody">
     ...
     <h4>Update Product </h4>
				...
				<form method="post" enctype="multipart/form-data" action="edpct.php">				
...
?>
   ...
   <label for="Product">Product Name</label>
							...
							<button type="submit" name="submit" class="mart4 btns">Update</button>
							</div>
							<?php			
							echo $msg;			
							?>
